...
function PhotoLibrary({ setImage,hidePhotoLibarary }) {
  ...
  return (
    ...
    <div className=" h-max w-max bg-gray-900 gap-6 rounded-lg p-4">
      <div className=" pt-2 pe-2 cursor-pointer flex items-end justify-end" onClick={()=>hidePhotoLibarary(false)}>
